...
status: resolved
symptom: Live CPU preparation is 5-7 ms but no nonblocking GPU timestamp evidence exists, so neither a 5 ms/200 fps nor 16.67 ms/60 fps renderer budget is established
