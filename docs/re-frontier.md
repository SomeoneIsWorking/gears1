...
- gap: The bound-vertex entry is statically grounded but lacks live coverage. Bound vertex/index resource state, resource lifetime, resolves, retirement, full-stream comparison, and pixel parity do not yet exist, so no native bypass is authorized.
