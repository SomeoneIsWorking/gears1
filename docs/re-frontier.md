...
- gap: The bound-vertex draw entry is statically grounded but lacks live coverage. Complete buffer view data, resource creation/lifetime, resolves, retirement, full-stream comparison, and pixel parity do not yet exist, so no native bypass is authorized.
