...
from gearsue3_imports.inventory import InventoryError, build, read_recovered_handlers
...
class ImportInventoryTests(unittest.TestCase):
    ...
    def test_joins_manifest_to_export_names_and_recovered_handlers(self) -> None:
        ...
        inventory = build(manifest, self.xenia, self.runtime)
