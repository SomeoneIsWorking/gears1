...
MAINTAINED_FILES = tuple(
    ...
    for path in (
        ...
        "runtime/engine/app/device_input.cpp",
        "runtime/engine/app/device_input.h",
        "runtime/engine/app/game_window.cpp",
        "runtime/engine/app/game_window.h",
        "runtime/engine/app/main.cpp",
        ...
        "runtime/engine/game/collision_world.cpp",
        "runtime/engine/game/collision_world.h",
        "runtime/engine/game/game_world.cpp",
        "runtime/engine/game/game_world.h",
        "runtime/engine/game/pawn_body.cpp",
        "runtime/engine/game/pawn_body.h",
        "runtime/engine/game/pawn_defaults.cpp",
        "runtime/engine/game/pawn_defaults.h",
        "runtime/engine/game/pawn_tuning.h",
        "runtime/engine/game/player_camera.cpp",
        "runtime/engine/game/player_camera.h",
        "runtime/engine/game/player_input.h",
        "runtime/engine/game/player_pawn.cpp",
        "runtime/engine/game/player_pawn.h",
        "runtime/engine/game/walking_movement.cpp",
        "runtime/engine/game/walking_movement.h",
        "runtime/engine/material/material_surfaces.cpp",
        "runtime/engine/material/material_surfaces.h",
        "runtime/engine/mesh/skeletal_mesh.cpp",
        "runtime/engine/mesh/skeletal_mesh.h",
        "runtime/engine/mesh/static_mesh.cpp",
        "runtime/engine/mesh/static_mesh.h",
        "runtime/engine/mesh/vector_math.h",
        "runtime/engine/object/bulk_data.cpp",
        "runtime/engine/object/bulk_data.h",
        "runtime/engine/object/class_defaults.cpp",
        "runtime/engine/object/class_defaults.h",
        ...
        "runtime/engine/render/draw_materials.cpp",
        "runtime/engine/render/draw_materials.h",
        "runtime/engine/render/frame_constants.cpp",
        "runtime/engine/render/frame_constants.h",
        ...
        "runtime/engine/render/swapchain.cpp",
        "runtime/engine/render/swapchain.h",
        ...
        "runtime/engine/render/window_frames.cpp",
        "runtime/engine/render/window_frames.h",
        ...
        "runtime/engine/scene/placement_properties.cpp",
        "runtime/engine/scene/placement_properties.h",
        "runtime/engine/scene/static_meshes.cpp",
        "runtime/engine/scene/static_meshes.h",
        "runtime/engine/scene/streaming_levels.cpp",
        "runtime/engine/scene/streaming_levels.h",
        "runtime/engine/scene/transform.cpp",
        "runtime/engine/scene/transform.h",
        "runtime/engine/scene/world.cpp",
        "runtime/engine/scene/world.h",
